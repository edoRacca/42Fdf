...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/09/08 11:51:42 by eraccane          #+#    #+#             */
/*   Updated: 2023/09/13 10:30:44 by eraccane         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	ft_rotate_x(line, cam->alpha);
	ft_rotate_y(line, cam->beta);
	ft_rotate_z(line, cam->gamma);
}
